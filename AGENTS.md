...
- Catalogo cerrado de challenges:
  - El conjunto activo es exactamente: `nonce_reuse`, `sampler_patterned_y`, `eta_unbounded_secret`, `gamma1_beta_boundary_oracle`, `gamma2_lowbits_boundary_oracle`, `gamma2_lowbits_pruned_recovery`, `verifier_no_ctilde`, `lambda_too_short_cross_message`, `toy_dense_hint_forgery`, `toy_params_too_small`.
