...
pub(crate) struct MldsaOid;

impl MldsaOid {
    pub(crate) fn for_parameter_set(
        parameter_set: ParameterSet,
    ) -> DilithiumResult<ObjectIdentifier> {
    ...
    pub(crate) fn parameter_set(oid: ObjectIdentifier) -> DilithiumResult<ParameterSet> {
        match oid {
...
pub fn oid_for_parameter_set(parameter_set: ParameterSet) -> DilithiumResult<ObjectIdentifier> {
    MldsaOid::for_parameter_set(parameter_set)
}
